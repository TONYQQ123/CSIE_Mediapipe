...
def Caculate_step(candidate):
    flag, number, step = 0, 0, 0
    ...
    if candidate[26].visibility>=0.5 and candidate[24].visibility>=0.5 and candidate[28].visibility>=0.5:
        knee_left=Angle(candidate[26].x,candidate[26].y,candidsate[24].x,candidate[24].y,candidate[28].x,candidate[28].y)
